...
train_matrix = np.zeros([100, 30000000], dtype=np.int8)
test_matrix = np.zeros([100,30000000], dtype=np.int8) 
...
test_files = genome_files[100:200]
...
clf = AdaBoostClassifier(DecisionTreeClassifier(max_depth=1, max_features="sqrt"), algorithm="SAMME")
